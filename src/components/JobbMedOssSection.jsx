          ...
          <div className="flex flex-col max-w-2xl gap-16 px-6 py-16 mx-auto bg-white/5 ring-1 ring-white/10 sm:rounded-3xl sm:p-8 lg:mx-0 lg:max-w-none lg:flex-row lg:items-center lg:py-20 xl:gap-x-20 xl:px-20">
            ...
            <div className="flex-auto w-full">
              <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">
                Ser du etter en ny utfordring?
              </h2>
              <p className="mt-6 text-lg leading-8 text-gray-300">
                Bli med teamet vårt og ta karrieren din til neste nivå!
              </p>
              ...
              <p className="mt-6 leading-8 text-gray-300">
                Hvis du har erfaring innen produksjonsplanlegging eller
                -ledelse, vil vi gjerne høre fra deg. Bli en del av vårt team av
                fagfolk!
              </p>

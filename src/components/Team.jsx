...
const people = [
  {
    ...
    bio: 'Med en VVS-ingeniørbakgrunn og omfattende erfaring innen prosjektutvikling har Frank ekspertise til å utvikle ideer til ferdige produkter. Han er også en erfaren entreprenør og konsulent med internasjonal handelskompetanse.',
  ...
  },
  {
    ...
    bio: 'Svein har en bred internasjonal erfaring og et omfattende nettverk innen HVAC-bransjen. Med 25 års erfaring med profesjonelle varmepumper og kjølesystemer har han oppnådd suksess ved etablering av selskaper for produsenter i Norge. Svein sin ekspertise omfatter prosjektering av anlegg for boliger, næringsbygg, fiskeoppdrett og grunnkjøling.',
...
export function Team() {
  return (
    <div className="py-24 mt-24 bg-gray-50 md:py-32 sm:mt-40">

...
export default function Kontakt() {
  return (
    <>
      <Head>
        <title>Kontakt Entalpy AS - Ta kontakt for varmepumpeløsninger</title>
        <meta
          name="description"
            ...
            <div className="relative px-6 pt-24 pb-20 sm:pt-32 lg:static lg:px-8 lg:py-48">
              <div className="max-w-xl mx-auto lg:mx-0 lg:max-w-lg">
                ...
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  Har du spørsmål, ønsker mer informasjon eller vil komme i
                  kontakt med oss? Ikke nøl med å ta kontakt via skjemaet
                  nedenfor, eller send oss en e-post direkte. Vi ser frem til å
                  høre fra deg!
                </p>
                <dl className="mt-10 space-y-4 text-base leading-7 text-gray-600">
                  ...
                  <div className="flex gap-x-4">
                    ...
                    <dd>
                      <a className="hover:text-gray-900" href="tel:905 64 983">
                        905 64 983
                      </a>
                    </dd>
                  </div>
            ...
            >
              ...
              <div className="max-w-xl mx-auto lg:mr-0 lg:max-w-lg">
                ...
                <div className="flex justify-end mt-8">
                  <button
                    type="submit"
                    className="rounded-lg bg-green-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-green-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600 transition-all duration-150 ease-in-out"
                  >
                    Send inn
                  </button>
                </div>
